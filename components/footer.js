...
export default function Footer(){
    return(
    <footer className="-4 bg-white sm:p-6 p-2 border-t-1">
        <div className="mx-auto max-w-6xl">
            <div className="mx-auto max-w-screen-xl">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://www.bootproject.se" className="flex items-center">
                            <Logo size="32" className="mr-2"/>
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Bootproject</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://www.bootproject.se" className="hover:underline">Bootproject</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/Bootproject" className="hover:underline ">Github</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://www.bootproject.se" className="hover:underline">Bootproject</a>. All Rights Reserved.
                    </span>
